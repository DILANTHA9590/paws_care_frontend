      ...
      {loaded ? (
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mt-6">
          {products.map((product) => {
            ...
            return (
              <Link key={_id} to={`/product/${productId}`}>
                <div className="bg-white rounded-xl shadow hover:shadow-lg transition duration-300 overflow-hidden flex flex-col h-full">
